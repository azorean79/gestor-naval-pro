...
export const technicalBulletins: TechnicalBulletin[] = [
  ...
  },
  {
    ...
    notes: [
      ...
      "Este boletim é o procedimento detalhado referido na secção 6.G do SB 43/21 Ver.3 quando existem canopy zip pullers metálicos com dano/corrosão.",
    ],
    rules: [
      {
  ...
  },
  {
    ...
    notes: [
      "Boletim analisado do PDF SB 43/21 Ver.3 (Oct/24), que rescinde as emissões por marca 27/21 a 37/21.",
      ...
      "A referência 05606009 mantém-se, mas o gasket seal usa adesivo revisto e deve ser substituído em cada revisão; o stock antigo continua utilizável.",
      "As novas valises 53769001 / 53770001 / 53771001 e 53793001 reduzem desperdício e tempo de inspeção; para bellows tipo pump o uso da bellows valise é obrigatório e pillowflex/bubblewrap deixa de ser permitido.",
      "Quando houver corrosão ou dano em um canopy zip puller metálico, todos os zip pullers da jangada devem ser substituídos por 12750009 em resina; não misturar metal e resina.",
      "O campo de registo no PDF continua a pedir a anotação exata 'SB 43/21 Ver.2 APPLIED', apesar de o boletim estar publicado como Version 3 Oct/24.",
  ...
  },
  {
    ...
    rules: [
      ...
      },
      {
        ...
        referenceAliases: ["15199001", "DSB00940220", "05886009", "12865009", "11801009", "11802009", "11803009", "11804009", "Z63703", "06556009", "06484009", "12162009", "12874009"],
        reasonSuffix: "consolidação ativa para futuras substituições/encomendas",
      },
      {
