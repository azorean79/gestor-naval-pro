        ...
        <div className="flex flex-col gap-3 rounded-2xl bg-white p-6 shadow-sm ring-1 ring-slate-200">
          ...
          <div className="grid gap-3 sm:grid-cols-3">
            <div className="rounded-xl bg-slate-50 p-4">
              ...
              <p className="mt-2 text-sm font-semibold text-slate-900">{formatDate(contacto.createdAt)}</p>
            </div>
            <div className="rounded-xl bg-slate-50 p-4">
              <p className="text-xs uppercase tracking-[0.2em] text-slate-500">Atualizado</p>
              <p className="mt-2 text-sm font-semibold text-slate-900">{formatDate(contacto.updatedAt)}</p>
            </div>
            <div className="rounded-xl bg-slate-50 p-4">
