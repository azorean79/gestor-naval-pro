...
export async function GET(req: NextRequest) {
  try {
    ...
    const message = error instanceof Error ? error.message : "Erro ao listar packs personalizados.";
...
export async function POST(req: NextRequest) {
  try {
    ...
    return buildDatabaseErrorResponse(error, "Erro ao criar pack personalizado.");
  }
}