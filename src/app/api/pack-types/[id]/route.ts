...
export async function GET(_req: NextRequest, context: { params: Promise<{ id: string }> }) {
  try {
    ...
    const message = error instanceof Error ? error.message : "Erro ao obter pack personalizado.";
...
export async function PUT(req: NextRequest, context: { params: Promise<{ id: string }> }) {
  try {
    ...
    return buildDatabaseErrorResponse(error, "Erro ao editar pack personalizado.");
  }
}
...
export async function DELETE(_req: NextRequest, context: { params: Promise<{ id: string }> }) {
  try {
    ...
    const message = error instanceof Error ? error.message : "Erro ao desativar pack personalizado.";
    return buildDatabaseErrorResponse(error, message);
  }
}