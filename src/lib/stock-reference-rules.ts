...
export const SB12_24_REFERENCE_RULES = [
  {
    ...
    tokens: ["tablet anti-seasick", "seasickness tablets", "comprimidos p/ enjoo", "comprimidos para enjoo"],
  },
  {
    canonical: "12865009",
    aliases: ["15199001", "DSB00940220", "05886009"],
...
function includesAnyNormalizedToken(normalized: string, tokens: readonly string[]) {
  return tokens.some((token) => normalized.includes(normalizeReferenceRuleText(token)));
}
