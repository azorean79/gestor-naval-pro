...
export type AppThemeName = 'azores' | 'noturno' | 'escuro' | 'vermelho' | 'oceano';

export const DEFAULT_APP_THEME: AppThemeName = 'escuro';
  ...
  return createTheme({
    ...
    components: {
      ...
      MuiAppBar: {
        styleOverrides: {
          root: {
            boxShadow: darkMode ? '0 18px 40px rgba(2, 6, 23, 0.52)' : '0 20px 44px rgba(124, 58, 237, 0.24)',
      ...
      MuiButton: {
        styleOverrides: {
          root: {
            ...
            paddingInline: 18,
            paddingBlock: 10,
            boxShadow: darkMode ? '0 12px 24px rgba(2, 6, 23, 0.35)' : '0 12px 24px rgba(91, 33, 182, 0.14)',
            border: darkMode ? '1px solid rgba(148,163,184,0.14)' : '1px solid rgba(124,58,237,0.08)',
          },
        },
      },
      MuiPaper: {
        styleOverrides: {
          root: {
            boxShadow: darkMode ? '0 18px 38px rgba(2, 6, 23, 0.46)' : '0 18px 38px rgba(76, 29, 149, 0.1)',
            backgroundImage: darkMode
      ...
      MuiOutlinedInput: {
        styleOverrides: {
          root: {
            borderRadius: 16,
            backgroundColor: darkMode ? '#111827' : 'rgba(255,255,255,0.94)',
            boxShadow: darkMode ? 'inset 0 1px 0 rgba(255,255,255,0.03)' : '0 10px 20px rgba(15,23,42,0.05)',
          },
          input: {
            fontSize: '1rem',
            color: preset.textPrimary,
      ...
      MuiCard: {
        styleOverrides: {
          root: {
            borderRadius: 22,
            overflow: 'hidden',
            border: darkMode ? '1px solid rgba(148,163,184,0.08)' : '1px solid rgba(124,58,237,0.08)',
            boxShadow: darkMode ? '0 18px 42px rgba(2,6,23,0.42)' : '0 18px 42px rgba(91,33,182,0.12)',
          },
        },
      },
      MuiInputBase: {
