...
const NaviosPorIlhaTipoClienteNoMemo = <T extends NavioGroupingItem>({
  navios,
...
export default React.memo(NaviosPorIlhaTipoClienteNoMemo) as typeof NaviosPorIlhaTipoClienteNoMemo;
